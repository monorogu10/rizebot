    ...
    .addFields(
      {
        ...
        value: commandLines([
          ...
          ['!geonrate <rupiah>', 'cek estimasi Geon dari nominal topup. Alias: `!kurs`, `!cek-harga`, `!harga`.'],
    ...
    embed.addFields(
      ...
      },
      {
        ...
        value: commandLines([
          ...
          ['!geonrate <rupiah>', 'cek Geon otomatis SociaBuzz. Alias user: `!kurs`, `!cek-harga`, `!harga`.'],
