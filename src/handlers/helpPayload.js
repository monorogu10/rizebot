    ...
    .addFields(
      {
        ...
        value: commandLines([
          ...
          ['/status [user]', 'lihat Ethergeon ID Card; target lain khusus admin/interviewer.'],
          ['/player nama:<gamertag>', 'cek ID Card player lain dengan autocomplete.'],
    ...
    embed.addFields(
      {
        ...
        value: commandLines([
          ...
          ['/minecraft online', 'lihat snapshot player online.'],
