...
test('every migrated command family maps to its internal handler command', () => {
  ...
  const cases = [
    ...
    ['geonrate', 'cek', { rupiah: 10000 }, '!geonrate cek 10000'],
    ['geonrate', 'set', { 'geon-per-1000': 150, alasan: 'Promo' }, '!geonrate set 150 | Promo'],
    ['geonrate', 'history', {}, '!geonrate history'],
    ['geonrate', 'reset', { alasan: 'Selesai promo' }, '!geonrate reset | Selesai promo'],
    ...
    ['topup', 'kirim', { nama: 'Damp', rupiah: 5000 }, '!tu Damp auto 5000'],
    ['topup', 'kupon', { geon: 1000, rupiah: 5000, jumlah: 2, hari: 7 }, '!gnrtkpn 1000 5000 2 7'],
    ['topup', 'resolve', { payment: 'sb_1234', nama: 'Damp' }, '!topup-resolve sb_1234 | Damp'],
